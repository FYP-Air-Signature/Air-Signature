...
class PDFViewerApp(Canvas):
    ...
    def load_pdf(self):
        ...
        if file_path:
            ...
            temp_dir = tempfile.TemporaryDirectory(dir=os.getcwd() + "\\temp")
    ...
    def sign_pdf(self):
        ...
        scripts = ["python", "signSubProcess/signpdf.py", self.fileName, self.imageName, "--coords",
